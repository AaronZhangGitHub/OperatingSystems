...
int main(){
    while(1){
        ...
        int loopCount = whitespaceSeperatorCount-2;
        //array for arguments
        char *argArray[whitespaceSeperatorCount-1];
        argArray[whitespaceSeperatorCount-2]=NULL; //Array of pointers must be terminated by null pointer
        //get the file path
